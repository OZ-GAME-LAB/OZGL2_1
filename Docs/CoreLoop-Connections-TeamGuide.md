...
2026-09-22 #49: InGame 일반 보상은 SO 기반 해금/가중치 추첨과 확장 불가 시 세 번째 유닛 대체를 사용한다. [일반 보상 연결 규격](CoreLoop-GeneralRewards-TeamGuide.md)을 참고한다. 계정 유닛 해금 저장소는 미연결이며 현재 명시적 기본 해금 목록을 사용한다.
