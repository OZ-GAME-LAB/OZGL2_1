...
namespace OZGL2.Grid.UI
{
    ...
    public sealed class GridBoardThemeSO : ScriptableObject
    {
        ...
        [SerializeField] private Color _availableBorder = new Color(0.2f, 0.26f, 0.24f);
        [SerializeField, Range(0, 0.25f)] private float _borderWidth = 0.0625f;
        ...
        public Color GetBorderColor(eGridCellSurface surface) => surface == eGridCellSurface.PLATFORM ? _platformBorder : _availableBorder;
